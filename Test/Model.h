...
public:
    ...
    void Draw(GLuint shaderProgram, float angle, float verticalOffset, float horizontalOffset)
    {
        ...
        for (unsigned int i = 0; i < meshes.size(); i++)
        {
            ...
            case 0:
                ...
                break;
            case 1: 
                modelMat = glm::translate(rotationMat, glm::vec3(0.0f, verticalOffset, 0.0f));
                break;
            case 2:
            ...
            case 3: 
                ...
                break;
            case 4:
                modelMat = glm::translate(glm::translate(rotationMat, glm::vec3(0.0f, verticalOffset, 0.0f)), glm::vec3(horizontalOffset, 0.0f, 0.0f));
                break;
            default:
                modelMat = glm::mat4(1.0f);
                break;
